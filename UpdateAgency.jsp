		...
		<form>
			<table class="table-responsive table-striped table-bordered"
				...
				<c:forEach var="row" items="${result.rows}">
					<tr>
						<td width="15%"><c:out value="${row.AgencyID}" />
						<td width="15%"><c:out value="${row.AgencyName}" />
						<td width="15%"><c:out value="${row.Address}" />
						<td width="15%"><c:out value="${row.ContactNo}" />
						<td width="15%"><c:out value="${row.No_of_Agents}" />
						<td width="15%"><c:out value="${row.Ratings}" />
						<td width="30%"><a href="/MiniProject/UpdateAgencyServlet">Update <i style="font-size:24px" class="fa">&#xf0a4;</i></a></td>
