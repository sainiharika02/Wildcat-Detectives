<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose j.dtd">
<html>
<head>
...
<body>
	...
	<center>
		<form method="post" action="RemoveAgentServlet">
			<br>
			<label for="Email"><font size="5" color="white">Email
					Id :</font></label> <input type="text" id="Email" name="Email" required> <br>
